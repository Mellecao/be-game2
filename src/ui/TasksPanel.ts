...
const STATUS_LABELS: Record<string, string> = {
  ...
  designing:        "Design",
  imagining:        "Gerando Imagens",
  reviewing_assets: "Revisando Imagens",
  regen_assets:     "Regenerando Imagens",
  modeling_3d:      "Gerando Modelos 3D",
  developing:       "Dev",
  reviewing:        "QA",
  revision:         "Revisão",
  deploying:        "Deploy",
  closing:          "Finalizando",
  curating:         "Curadoria Final",
  done:             "Concluído",
  error:            "Erro",
  cancelled:        "Cancelado",
};
...
const STEP_LABELS: Record<string, string> = {
  ...
  planning:         "1/10 — Planejamento",
  copywriting:      "2/10 — Copywriting",
  designing:        "3/10 — Design",
  imagining:        "4/10 — Gerando Imagens",
  reviewing_assets: "5/10 — Revisão de Imagens",
  regen_assets:     "5/10 — Regenerando Imagens",
  modeling_3d:      "6/10 — Modelos 3D",
  developing:       "7/10 — Desenvolvimento",
  reviewing:        "8/10 — QA",
  revision:         "8/10 — Revisão solicitada",
  deploying:        "9/10 — Deploy",
  closing:          "10/10 — Finalizando",
  curating:         "C — Curadoria Final",
  done:             "✓ Concluído",
  error:            "✗ Erro",
  cancelled:        "— Cancelado",
};
